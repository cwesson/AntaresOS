...
/**
 * Swap endianness of 16bit integer.
...
/**
 * Swap endianness of 32bit integer.
 * @param x Integer to swap endianness of.
 * @return Resulting integer.
 */
...
/**
 * Swap endianness of 64bit integer.
 * @param x Integer to swap endianness of.
 * @return Resulting integer.
 */
static inline unsigned long long endian_swap64(unsigned long long x){
	...
	/**
	 * If system is little endian, swap endianness of 16bit integer.
	 * @param x Integer to swap endianness of.
	 * @return Resulting integer.
	 */
	...
	/**
	 * If system is little endian, swap endianness of 32bit integer.
	 * @param x Integer to swap endianness of.
	 * @return Resulting integer.
	 */
	...
	/**
	 * If system is little endian, swap endianness of 64bit integer.
	 * @param x Integer to swap endianness of.
	 * @return Resulting integer.
	 */
	...
	/**
	 * If system is big endian, swap endianness of 16bit integer.
	 * @param x Integer to swap endianness of.
	 * @return Resulting integer.
	 */
	...
	/**
	 * If system is big endian, swap endianness of 32bit integer.
	 * @param x Integer to swap endianness of.
	 * @return Resulting integer.
	 */
	...
	/**
	 * If system is big endian, swap endianness of 64bit integer.
	 * @param x Integer to swap endianness of.
	 * @return Resulting integer.
	 */
